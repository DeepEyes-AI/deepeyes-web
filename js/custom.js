...
function showSlides(n) {
  ...
  if (n > 1) {
    prev[0].className += " arrow-active";
  } else {
    prev[0].className = prev[0].className.replaceAll(" arrow-active", "");
  }

  if (n < slides.length) {
    next[0].className += " arrow-active";
  } else {
    next[0].className = next[0].className.replaceAll(" arrow-active", "");
  }
